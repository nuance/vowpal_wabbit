...
vw parse_args(int argc, char *argv[])
{
  ...
  desc.add_options()
    ...
    ("listen_address", po::value<string>(&all.listen_address), "Address to listen for all-reduce connections on")
    ("listen_port", po::value<int>(&all.listen_port), "Port to listen for all-reduce connections on")
